...
1. [Mental Model: One Read Through the Cache Stack](#1-mental-model-one-read-through-the-cache-stack)
2. [Caching Strategies Overview](#2-caching-strategies-overview)
3. [Cache-Aside Pattern (Lazy Loading)](#3-cache-aside-pattern-lazy-loading)
...
8. [TTL, Eviction, and Memory Management](#8-ttl-eviction-and-memory-management)
9. [Cache Stampede and Thundering Herd](#9-cache-stampede-and-thundering-herd)
10. [Redis Architecture and Data Structures](#10-redis-architecture-and-data-structures)
11. [Spring Cache Abstraction](#11-spring-cache-abstraction)
12. [Spring Boot + Redis Integration](#12-spring-boot-redis-integration)
13. [Distributed Caching in Microservices](#13-distributed-caching-in-microservices)
14. [Consistency, Staleness, and CAP Trade-offs](#14-consistency-staleness-and-cap-trade-offs)
15. [Observability: Metrics, Traces, and Alerts](#15-observability-metrics-traces-and-alerts)
