...
1. [0. The 45-Minute Interview Playbook](#0-the-45-minute-interview-playbook)
2. [1. Clarification Questions Framework](#1-clarification-questions-framework)
3. [2. Back-of-Envelope Math](#2-back-of-envelope-math)
4. [3. API Design Sketch Framework](#3-api-design-sketch-framework)
5. [4. Data Model Sketch Framework](#4-data-model-sketch-framework)
6. [5. Component Diagram Framework](#5-component-diagram-framework)
7. [6. Tradeoff Narration](#6-tradeoff-narration)
8. [7. Non-Functional Requirements Framework](#7-non-functional-requirements-framework)
9. [8. Walkthrough: URL Shortener](#8-walkthrough-url-shortener)
10. [9. Walkthrough: Payment / Checkout](#9-walkthrough-payment--checkout)
11. [10. Walkthrough: Notification System](#10-walkthrough-notification-system)
12. [11. Walkthrough: Feed / Timeline (Twitter-like)](#11-walkthrough-feed--timeline-twitter-like)
13. [12. Walkthrough: Rate Limiter / API Gateway](#12-walkthrough-rate-limiter--api-gateway)
14. [13. Walkthrough: Search / Catalog](#13-walkthrough-search--catalog)
15. [14. Walkthrough: File Upload / Media Storage](#14-walkthrough-file-upload--media-storage)
16. [15. Walkthrough: Order Management / Inventory](#15-walkthrough-order-management--inventory)
17. [16. General Interview Playbook](#16-general-interview-playbook)
18. [17. Quick Decision Matrix](#17-quick-decision-matrix)
19. [18. Cross-Cutting Scenario Q&A (20 Questions)](#18-cross-cutting-scenario-qa-20-questions)
