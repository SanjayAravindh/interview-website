...
1. [Mental Model: Auto-Configuration](#1-mental-model-auto-configuration)
2. [@SpringBootApplication](#2-springbootapplication)
3. [@EnableAutoConfiguration](#3-enableautoconfiguration)
4. [spring.factories vs AutoConfiguration.imports (Boot 3)](#4-springfactories-vs-autoconfigurationimports-boot-3)
5. [@ConditionalOn* Family](#5-conditionalon-family)
6. [@AutoConfigureBefore / @AutoConfigureAfter / @AutoConfigureOrder](#6-autoconfigurebefore-autoconfigureafter-autoconfigureorder)
7. [Writing Custom Auto-Configuration](#7-writing-custom-auto-configuration)
8. [Starters Anatomy](#8-starters-anatomy)
9. [Dependency Management & BOM](#9-dependency-management-bom)
10. [Externalized Configuration Fundamentals](#10-externalized-configuration-fundamentals)
11. [Properties, YAML, Environment Variables](#11-properties-yaml-environment-variables)
12. [Profiles](#12-profiles)
13. [@ConfigurationProperties + Validation + Records](#13-configurationproperties-validation-records)
14. [PropertySource Order & Relaxed Binding](#14-propertysource-order-relaxed-binding)
15. [Spring Boot Actuator Overview](#15-spring-boot-actuator-overview)
16. [Health, Liveness, Readiness](#16-health-liveness-readiness)
17. [Metrics & Micrometer Integration](#17-metrics-micrometer-integration)
18. [Loggers, Env, Info Endpoints](#18-loggers-env-info-endpoints)
19. [Actuator Security](#19-actuator-security)
20. [Custom Health Indicators](#20-custom-health-indicators)
21. [Graceful Shutdown](#21-graceful-shutdown)
22. [Embedded Tomcat / Jetty / Netty Tuning](#22-embedded-tomcat-jetty-netty-tuning)
23. [DevTools (Dev Only)](#23-devtools-dev-only)
24. [Spring Boot Docker Layers & Container Images](#24-spring-boot-docker-layers-container-images)
25. [Build Info](#25-build-info)
26. [Test Slices](#26-test-slices)
27. [Production Scenarios Capstone](#27-production-scenarios-capstone)
28. [Production Debugging Playbook](#28-production-debugging-playbook)
29. [Quick Decision Matrix](#29-quick-decision-matrix)
30. [Interview Q&A (15+)](#30-interview-qa-15)
