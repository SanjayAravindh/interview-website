...
10. [@RequestBody and @ResponseBody](#10-requestbody-and-responsebody)
11. [Jackson Integration](#11-jackson-integration)
12. [Validation: @Valid, @Validated, and Groups](#12-validation-valid-validated-and-groups)
13. [Exception Handling: @ControllerAdvice and ProblemDetail (RFC 7807)](#13-exception-handling-controlleradvice-and-problemdetail-rfc-7807)
14. [Filters vs Interceptors vs Security Filter Chain Order](#14-filters-vs-interceptors-vs-security-filter-chain-order)
15. [Embedded Tomcat Thread Pool and maxThreads](#15-embedded-tomcat-thread-pool-and-maxthreads)
16. [Virtual Threads (Boot 3.2+)](#16-virtual-threads-boot-32)
17. [Multipart Uploads and File Download](#17-multipart-uploads-and-file-download)
18. [CORS and Static Resources](#18-cors-and-static-resources)
19. [Async MVC: DeferredResult, Callable, and @Async](#19-async-mvc-deferredresult-callable-and-async)
20. [Server-Sent Events on the Servlet Stack](#20-server-sent-events-on-the-servlet-stack)
21. [OpenAPI, springdoc, Pageable, and HATEOAS (Brief)](#21-openapi-springdoc-pageable-and-hateoas-brief)
22. [Production Pitfalls: OSIV, Jackson, Lazy Load, Threads, Timeouts, MVC vs WebFlux](#22-production-pitfalls-osiv-jackson-lazy-load-threads-timeouts-mvc-vs-webflux)
