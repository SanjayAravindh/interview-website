...
1. [Mental Model: Event Loop vs Thread-Per-Request](#1-mental-model-event-loop-vs-thread-per-request)
2. [Project Reactor: Mono, Flux, Operators, Cold vs Hot](#2-project-reactor-mono-flux-operators-cold-vs-hot)
3. [DispatcherHandler vs DispatcherServlet](#3-dispatcherhandler-vs-dispatcherservlet)
4. [RouterFunctions vs Annotated Controllers](#4-routerfunctions-vs-annotated-controllers)
5. [WebClient: Pooling, Timeouts, Retries, Exchange Strategies](#5-webclient-pooling-timeouts-retries-exchange-strategies)
6. [Backpressure, Prefetch, and boundedElastic Misuse](#6-backpressure-prefetch-and-boundedelastic-misuse)
7. [Blocking Calls on Reactive Threads](#7-blocking-calls-on-reactive-threads)
8. [Schedulers and Context Propagation](#8-schedulers-and-context-propagation)
9. [Security on WebFlux (SecurityWebFilterChain)](#9-security-on-webflux-securitywebfilterchain)
10. [R2DBC vs Blocking JDBC Bridge](#10-r2dbc-vs-blocking-jdbc-bridge)
11. [Error Handling: onError*, GlobalExceptionHandler, ProblemDetail](#11-error-handling-onerror-globalexceptionhandler-problemdetail)
12. [SSE and Streaming Responses](#12-sse-and-streaming-responses)
13. [WebSocket on WebFlux](#13-websocket-on-webflux)
14. [Testing: StepVerifier and WebTestClient](#14-testing-stepverifier-and-webtestclient)
15. [Observability: Micrometer, Context Propagation, Tracing](#15-observability-micrometer-context-propagation-tracing)
16. [Spring Cloud Gateway Integration (Brief)](#16-spring-cloud-gateway-integration-brief)
17. [Virtual Threads vs WebFlux in Boot 3.2+](#17-virtual-threads-vs-webflux-in-boot-32)
18. [Common Production Failures](#18-common-production-failures)
19. [Performance Tuning and Netty Server Options](#19-performance-tuning-and-netty-server-options)
20. [Reactive Data Access Patterns](#20-reactive-data-access-patterns)
