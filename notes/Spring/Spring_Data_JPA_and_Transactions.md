...
4. [Lazy Loading, N+1, Fetch Joins, @EntityGraph, Batch Fetching](#4-lazy-loading-n1-fetch-joins-entitygraph-batch-fetching)
5. [Transaction Management: @Transactional Propagation, Isolation, readOnly](#5-transaction-management-transactional-propagation-isolation-readonly)
6. [PlatformTransactionManager & TransactionSynchronization](#6-platformtransactionmanager-transactionsynchronization)
7. [Transaction Boundaries: Service Layer, Self-Invocation, Private Methods](#7-transaction-boundaries-service-layer-self-invocation-private-methods)
8. [Open Session In View (OSIV) / spring.jpa.open-in-view](#8-open-session-in-view-osiv-springjpaopen-in-view)
9. [Flush Modes, Dirty Checking, merge vs persist vs update](#9-flush-modes-dirty-checking-merge-vs-persist-vs-update)
10. [Optimistic vs Pessimistic Locking (@Version, LockModeType)](#10-optimistic-vs-pessimistic-locking-version-lockmodetype)
11. [Auditing (@CreatedDate, Envers)](#11-auditing-createddate-envers)
12. [Specifications, Criteria API, Querydsl](#12-specifications-criteria-api-querydsl)
13. [Native Queries, SqlResultSetMapping, Stored Procedures](#13-native-queries-sqlresultsetmapping-stored-procedures)
14. [Multi-Tenancy (Discriminator, Schema, Database)](#14-multi-tenancy-discriminator-schema-database)
15. [Second-Level Cache Pitfalls](#15-second-level-cache-pitfalls)
16. [Connection Pool + Transaction Timeout Interactions](#16-connection-pool-transaction-timeout-interactions)
17. [@Modifying Queries, Bulk Updates, clearAutomatically](#17-modifying-queries-bulk-updates-clearautomatically)
18. [Testing: @DataJpaTest, Testcontainers, @Transactional Rollback](#18-testing-datajpatest-testcontainers-transactional-rollback)
19. [Spring Data JDBC vs JPA — When to Use Which](#19-spring-data-jdbc-vs-jpa-when-to-use-which)
